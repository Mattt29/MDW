...
PATH = "../../data/"
file = PATH + 'data_tournages_2021.xlsx'
...
toponymes_file = PATH + 'ancien_geojson/TOPONYME_Clip__FeaturesToJSO.geojson'
routes_file = PATH + 'ancien_geojson/routes_nommées_FeaturesToJSO.geojson'
communes_file = PATH + 'ancien_geojson/COMMUNE_Clip_P_FeaturesToJSO.geojson'
